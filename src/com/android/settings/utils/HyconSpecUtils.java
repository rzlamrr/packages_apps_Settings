...
public class HyconSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String MAINTAINER_NAME_MODEL_PROPERTY = "ro.hycon.maintainer";
    private static final String HYCON_CPU_MODEL_PROPERTY = "ro.hycon.cpu";
    private static final String FALLBACK_CPU_MODEL_PROPERTY = "ro.board.model";
    private static final String HYCON_MAINTAINER_PROPERTY = "ro.hycon.maintainer";
    ...
    public static String getProcessorModel() {
        String cpuModelHycon = SystemProperties.get(HYCON_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelHycon.isEmpty()) {
            return cpuModelHycon;
